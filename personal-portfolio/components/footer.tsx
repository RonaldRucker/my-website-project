...
const socials = [
  { label: 'GitHub', href: 'https://github.com/ronaldrucker' },
  { label: 'Twitter / X', href: 'https://twitter.com/ronnierrucker' },
  { label: 'Instagram', href: 'https://instagram.com/ronnierrucker' },
  { label: 'LinkedIn', href: 'https://linkedin.com/in/ronaldrucker' },
]
...
function SocialIcon({ label }: { label: string }) {
  if (label === 'GitHub')
    return (
      <svg viewBox="0 0 98 96" className="size-3.5" fill="currentColor" aria-hidden>
